...
- [Puppeteer](#puppeteer)
          - [API | [FAQ](#faq) | [Contributing](https://github.com/puppeteer/puppeteer/blob/main/CONTRIBUTING.md) | [Troubleshooting](https://github.com/puppeteer/puppeteer/blob/main/docs/troubleshooting.md)](#api--faq--contributing--troubleshooting)
          - [What can I do?](#what-can-i-do)
  - [Getting Started](#getting-started)
    - [Installation](#installation)
    - [puppeteer-core](#puppeteer-core)
    - [Usage](#usage)
  - [Default runtime settings](#default-runtime-settings)
  - [Resources](#resources)
...
- [FAQ](#faq)
      ...
      - [Q: What are Puppeteer’s goals and principles?](#q-what-are-puppeteers-goals-and-principles)
      - [Q: Is Puppeteer replacing Selenium/WebDriver?](#q-is-puppeteer-replacing-seleniumwebdriver)
      - [Q: Why doesn’t Puppeteer v.XXX work with Chromium v.YYY?](#q-why-doesnt-puppeteer-vxxx-work-with-chromium-vyyy)
      ...
      - [Q: What’s considered a “Navigation”?](#q-whats-considered-a-navigation)
      - [Q: What’s the difference between a “trusted" and "untrusted" input event?](#q-whats-the-difference-between-a-trusted-and-untrusted-input-event)
      ...
      - [Q: How do I try/test a prerelease version of Puppeteer?](#q-how-do-i-trytest-a-prerelease-version-of-puppeteer)
      - [Q: I have more questions! Where do I ask?](#q-i-have-more-questions-where-do-i-ask)
